    ...
    for idx, article in enumerate(article_rows):
        ...
        point_rows.append(
            (
                ...
                ring_index,
                ring_key,
                0,                  # sector_index: v1 stub
                "subcluster_0",     # sector_key: v1 stub
                "0",                # subcluster_id: v1 stub
                "Subcluster 0",     # subcluster_label: v1 stub
                distance_to_centroid,
                distance_quantile,
                None,               # membership_confidence
                None,               # outlier_score
                None,               # nearest_neighbor_distance
                None,               # nearest_alternative_cluster_id
                None,               # nearest_alternative_cluster_distance
                is_core,
                is_edge,
                is_outlier_risk,
                is_outlier,
    ...
    with conn.cursor() as cur:
        cur.execute(
            ...
            (
                ...
                4,
                "subclusters",
                1 if stats["article_count"] > 0 else 0,
                stats["article_count"],
                stats["core_count"],
                stats["mid_count"],
                stats["edge_count"],
